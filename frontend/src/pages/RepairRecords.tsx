    ...
    return (
        <div className="p-6 bg-gray-100">
            ...
            <ul className="space-y-4">
                ...
                >
                    <div>
                        <span className="block text-lg font-semibold">Repair Record ID: {repairrecord.recordId}</span>
                        <span className="block text-sm text-gray-500">Mechanic Name: {repairrecord.mechanic}</span>
                        <span className="block text-sm text-gray-500">Estimated Repair Time: {repairrecord.estimatedRepairTime} hours</span>
                        <span className="block text-sm text-gray-500">Truck Being Repaired: {repairrecord.truck}</span>
                    </div>
                    <div>
                        <button 
